...
**Files Modified:**
- `content-script.js`: Added `captureSelection()` function, updated `handleCopy()`
...
**Files Modified:**
- `content-script.js`: Updated `buildCfHtml()` function
...
**Files Modified:**
- `content-script.js`: Updated `ensureMathTools()` function
...
**Files Modified:**
- `content-script.js`: Added safe parsing functions, replaced innerHTML usage
...
**Files Modified:**
- `background.js`: Refactored context menu creation
...
**Files Modified:**
- `content-script.js`: Enhanced error handling throughout
...
**Files Modified:**
- `content-script.js`: Updated `extractLatex()` function
...
**Files Modified:**
- `content-script.js`: Added `LRUCache` class, updated `convertLatexInHtml()`
...
**Files Modified:**
- `content-script.js`: Added feature detection in `writeClipboard()` and `latexToOmml()`
...
**Files Modified:**
- `content-script.js`: Updated `fallbackExecCopy()` with documentation
...
**Files Modified:**
- `content-script.js`: Added cross-frame detection in `captureSelection()`
...
**Files Modified:**
- `content-script.js`: Added large selection detection
...
**Files Modified:**
- `content-script.js`: Enhanced selection validation
...
**Files Modified:**
- `content-script.js`: Enhanced `latexToOmml()` function
...
**Files Modified:**
- `content-script.js`: Added timeouts to conversion functions

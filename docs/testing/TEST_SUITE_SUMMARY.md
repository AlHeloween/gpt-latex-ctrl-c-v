...
- `examples/test_selection_loss.html` - Selection loss test page
- `examples/test_xss_payloads.html` - XSS prevention test page
- `examples/test_large_selection.html` - Large selection test page
- `examples/test_edge_cases.html` - Edge cases test page
- `examples/test_iframe.html` - Cross-frame test page
- `examples/test_error_conditions.html` - Error conditions test page

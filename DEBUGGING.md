...
1. Verify extension is loaded:
   ...
   - If not there, click "Load Temporary Add-on" and select `manifest.json`
...
1. Check MathJax loading:
   ...
   - If not, check `mathjax/tex-mml-chtml.js` exists

2. Check XSLT loading:
   - Console should not show XSLT errors
   - Check `assets/mathml2omml.xsl` exists
...
2. Open test HTML file: `tests/gemini-conversation-test.html`
